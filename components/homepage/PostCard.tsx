...
export default function PostCard() {
  return (
    <div className="space-y-3 p-5 border-b border-neutral-300/50 hover:bg-gray-100 transition-colors duration-500 cursor-pointer">
      ...
      <div className=" px-4">
        ...
        <p>
          Following all the instruction of the module , I set up my vs code. And
          now I'm facing a problem that is showing wrong output. I have created
          intput.txt and output.txt. I.m taking input 45 to show this number but
          showing long digit number.
        </p>
      </div>
      <div className=" px-4">
        <img
